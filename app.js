...
function renderLogin() {
    return `
        <div style="display: flex; align-items: center; justify-content: center; min-height: calc(100vh - 180px); position: relative;">
            ...
            <!-- Full Body Walking Chef Animation -->
            <div class="chef-walk-wrapper">
                <div class="chef-float">
                    ...
                    <img src="https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Shallow%20pan%20of%20food/3D/shallow_pan_of_food_3d.png" style="width: 85px; position: absolute; top: 120px; left: 0px; transform: rotate(-15deg); filter: drop-shadow(2px 4px 6px rgba(0,0,0,0.5));" alt="3D Full Dish">
                </div>
            </div>
